  ...
  callWithJQuery(function($) {
              ...
              push: function(record) {
                ...
                if (mode === 'min' || mode === 'max') {
                  ...
                  if (!isNaN(x)) {
                    this.val = Math[mode](
                      x,
                      (ref = this.val) != null ? ref : x
                    );
                  }
                }
                if (mode === 'first') {
                  if (
                    this.sorter(x, (ref1 = this.val) != null ? ref1 : x) <= 0
                  ) {
                    this.val = x;
                  }
                }
                if (mode === 'last') {
                  if (
                    this.sorter(x, (ref2 = this.val) != null ? ref2 : x) >= 0
                  ) {
                    return (this.val = x);
                  }
                }
          ...
          return function(data, rowKey, colKey) {
            return {
              ...
              value: function() {
                ...
                return (
                  (this.vals[Math.floor(i)] + this.vals[Math.ceil(i)]) / 2.0
                );
              },
              format: formatter,
              numInputs: attr != null ? 0 : 1,
          ...
          return function(data, rowKey, colKey) {
            return {
              ...
              value: function() {
                return (
                  this.inner.value() /
                  data.getAggregator.apply(data, this.selector).inner.value()
                );
              },
    ...
    PivotData = (function() {
      function PivotData(input, opts) {
        ...
        this.input = input;
        this.aggregator =
          (ref = opts.aggregator) != null ? ref : aggregatorTemplates.count()();
        this.aggregatorName =
          (ref1 = opts.aggregatorName) != null ? ref1 : 'Count';
        ...
        this.derivedAttributes =
          (ref8 = opts.derivedAttributes) != null ? ref8 : {};
        this.filter =
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        materializedInput = [];
        recordsProcessed = 0;
        PivotData.forEachRecord(input, opts.derivedAttributes, function(
          record
        ) {
          ...
          if (values.length > opts.menuLimit) {
                ...
                .bind('keyup', function() {
                  ...
                  accept_gen = function(prefix, accepted) {
                    return function(v) {
                      ...
                      return (
                        (ref1 = Math.sign(
                          sorter(v.toLowerCase(), real_filter)
                        )),
            ...
            for (n = 0, len2 = ref1.length; n < len2; n++) {
              ...
              if (opts.inclusions[attr]) {
                filterItemExcluded =
                  indexOf.call(opts.inclusions[attr], value) < 0;
              } else if (opts.exclusions[attr]) {
                filterItemExcluded =
                  indexOf.call(opts.exclusions[attr], value) >= 0;
              }
        ...
        for (n = 0, len2 = ref2.length; n < len2; n++) {
          ...
          this.find('.pvtCols').append(
            this.find('.axis_' + $.inArray(x, shownInDragDrop))
          );
        }
        ref3 = opts.rows;
        ...
        refreshDelayed = (function(_this) {
          return function() {
            ...
            numInputsToProcess =
              (ref4 = opts.aggregators[aggregator.val()]([])().numInputs) !=
              null
                ? ref4
                : 0;
            vals = [];
            ...
            if (opts.autoSortUnusedAttrs) {
              unusedAttrsContainer = _this.find(
    ...
    $.fn.heatmap = function(scope, opts) {
      ...
      colorScaleGenerator =
        opts != null
          ? (ref = opts.heatmap) != null ? ref.colorScaleGenerator : void 0
          : void 0;

(function($) {
  ...
  makeHighChart = function(chartType, extraOptions) {
    return function(pivotData, opts) {
      ...
      var $result = $("<div class='novixTable'>")
        .width(opts.$el.find('.pvtRendererArea').width() - 5)
        .height(opts.$el.find('.pvtRendererArea').height() - 5);
  ...
  return ($.pivotUtilities.highchart_renderers = {
    ...
    'Stacked Bar Chart': makeHighChart('bar', {
      plotOptions: { series: { stacking: 'normal' } },
    }),
    'Column Chart': makeHighChart('column'),
    'Stacked Column Chart': makeHighChart('column', {
      plotOptions: { series: { stacking: 'normal' } },
    }),
    'Area Chart': makeHighChart('area', {
      plotOptions: { series: { stacking: 'normal' } },
    }),

      ...
      try {
          ...
          $('<p>')
            ...
            .append(
              $('<button>', {
                ...
                .text('OK')
                .bind('click', updateFilter)
            );
          showFilterList = function(e) {
            var clickLeft, clickTop, ref3;
            (ref3 = $(e.currentTarget).position()),
              (clickLeft = ref3.left),
              (clickTop = ref3.top);
            valueList
              .css({
        ...
        for (o = 0, len3 = ref3.length; o < len3; o++) {
          ...
          this.find('.pvtCols').append(
            this.find('.axis_' + $.inArray(x, shownAttributes))
          );
        }
        ref4 = opts.rows;
        ...
        refreshDelayed = (function(_this) {
          return function() {
            ...
            numInputsToProcess =
              (ref5 = opts.aggregators[aggregator.val()]([])().numInputs) !=
              null
                ? ref5
                : 0;
            vals = [];
            ...
            if (numInputsToProcess !== 0) {
              ...
              for (
                x = s = 0, ref6 = numInputsToProcess;
                0 <= ref6 ? s < ref6 : s > ref6;
                x = 0 <= ref6 ? ++s : --s
              ) {
                newDropdown = $('<select>')
            ...
            subopts.filter = function(record) {
              ...
              for (k in exclusions) {
                ...
                if (
                  ((ref7 = '' + record[k]),
                  indexOf.call(excludedItems, ref7) >= 0)
                ) {
                  return false;
                }
              }

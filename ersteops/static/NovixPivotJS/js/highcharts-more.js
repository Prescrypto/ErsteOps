...
(function(k, D) {
  ...
  H(K.prototype, {
    init: function(a, b, c) {
      ...
      d.options = a = o(e, a);
      (a = a.background) &&
        u([].concat(L(a)).reverse(), function(a) {
  ...
  var G = M.prototype,
    ...
    O = {
      ...
      setAxisSize: function() {
        ...
        if (this.isRadial) {
          this.center = this.pane.center = k.CenteredSeriesMixin.getCenter.call(
            this.pane
          );
          if (this.isCircular)
            this.sector = this.endAngleRad - this.startAngleRad;
          this.len = this.width = this.height =
            this.center[2] * q(this.sector, 1) / 2;
        }
      },
      getPosition: function(a, b) {
        return this.postTranslate(
          this.isCircular ? this.translate(a) : 0,
          q(this.isCircular ? b : this.translate(a), this.center[2] / 2) -
            this.offset
        );
      },
  ...
  r(G, 'init', function(a, b, c) {
    ...
    if (!h && (d || e)) {
      a = this.options;
      if (!b.panes) b.panes = [];
      this.pane = ((j = b.panes[m] =
        b.panes[m] || new K(L(l.pane)[m], b, this)),
      (m = j));
      m = m.options;
      b.inverted = !1;
      ...
      this.endAngleRad = l =
        (q(m.endAngle, m.startAngle + 360) - 90) * Math.PI / 180;
      this.offset = a.offset || 0;
      if ((this.isCircular = i) && c.max === D && l - b === 2 * Math.PI)
        this.autoConnect = !0;
    }
  });
  ...
  r(y, 'getLabelPosition', function(a, b, c, d, e, f, h, i, l) {
    var m = this.axis,
      ...
      g = f.align,
      A =
        ((m.translate(this.pos) + m.startAngleRad + Math.PI / 2) /
          Math.PI *
          180) %
        360;
    m.isRadial
      ? ((a = m.getPosition(this.pos, m.center[2] / 2 + q(f.distance, -25))),
        f.rotation === 'auto'
          ? d.attr({ rotation: A })
          : j === null &&
            (j =
              m.chart.renderer.fontMetrics(d.styles.fontSize).b -
              d.getBBox().height / 2),
        g === null &&
          (m.isCircular
            ? (this.label.getBBox().width >
                m.len * m.tickInterval / (m.max - m.min) && (n = 0),
              (g =
                A > n && A < 180 - n
                  ? 'left'
                  : A > 180 + n && A < 360 - n ? 'right' : 'center'))
            : (g = 'center'),
          d.attr({ align: g })),
        (a.x += f.x),
        (a.y += j))
      : (a = a.call(this, b, c, d, e, f, h, i, l));
    return a;
  });
  ...
  g.arearange = v(g.area, {
    ...
    translate: function() {
      ...
      u(a.points, function(a) {
        ...
        e === null && d === null
          ? (a.y = null)
          : d === null
            ? ((a.plotLow = a.plotY = null),
              (a.plotHigh = b.translate(e, 0, 1, 0, 1)))
            : e === null
              ? ((a.plotLow = f), (a.plotHigh = null))
              : ((a.plotLow = f), (a.plotHigh = b.translate(e, 0, 1, 0, 1)));
      });
      this.chart.polar &&
    ...
    getSegmentPath: function(a) {
      ...
      for (
        ...
        (f = a[d]),
          f.plotHigh !== null &&
            c.push({ plotX: f.plotHighX || f.plotX, plotY: f.plotHigh });
      a = e.call(this, b);
      if (i)
        i === !0 && (i = 'left'),
          (h.step = { left: 'right', center: 'center', right: 'left' }[i]);
      c = e.call(this, c);
      h.step = i;
      h = [].concat(a, c);
  ...
  z = {
    ...
    translate: function() {
      ...
      u(this.points, function(d) {
        ...
        j && typeof j === 'number'
          ? ((j = j / 180 * Math.PI),
            (n = Math.max(a.startAngleRad - j, Math.min(a.endAngleRad + j, n))))
          : b.wrap === !1 &&
  ...
  g.waterfall = v(g.column, {
    ...
    translate: function() {
      ...
      for (c = 0, a = d.length; c < a; c++) {
        ...
        f = e.shapeArgs;
        j = (h =
          k && b.stacks[(this.negStacks && i < n ? '-' : '') + this.stackKey])
          ? h[e.x].points[this.index + ',' + c]
          : [0, i];
        if (e.isSum) e.y = i;
        else if (e.isIntermediateSum) e.y = i - m;
        h = N(l, l + e.y) + j[0];
        f.y = b.translate(h, 0, 1);
        if (e.isSum)
          (f.y = b.translate(j[1], 0, 1)),
            (f.height = b.translate(j[0], 0, 1) - f.y);
        else if (e.isIntermediateSum)
          (f.y = b.translate(j[1], 0, 1)),
            (f.height = b.translate(m, 0, 1) - f.y),
            (m = j[1]);
        else {
          if (l !== 0)
            f.height =
              i > 0
                ? b.translate(l, 0, 1) - f.y
                : b.translate(l, 0, 1) - b.translate(l - i, 0, 1);
          l += i;
        }
    ...
    processData: function(a) {
      ...
      for (j = 0; j < e; j++)
        (m = b[j]),
          ...
          m === 'sum' || d.isSum
            ? (b[j] = h)
            : m === 'intermediateSum' || d.isIntermediateSum
              ? (b[j] = f)
              : ((h += m), (f += m)),
          (i = Math.min(h, i)),
          (l = Math.max(h, l));
    ...
    getAttribs: function() {
      ...
      u(a.points, function(b) {
        if (!b.options.color)
          b.y > 0
            ? ((b.pointAttr = e), (b.color = d))
            : (b.pointAttr = a.pointAttr);
      });
    },
    getGraphPath: function() {
      ...
      for (h = 1; h < b; h++)
        (f = a[h].shapeArgs),
          ...
          a[h - 1].y < 0 && ((f[2] += e.height), (f[5] += e.height)),
          (d = d.concat(f));
      return d;
    },
    getExtremes: t,
            ...
            b.length &&
              ((j = q(
                ...
                w.min(
                  ...
                  w.max(
                    P(b),
                    h.displayNegative === !1 ? h.zThreshold : -Number.MAX_VALUE
                  )
                )
              )),
    ...
    u(p, function(a) {
      ...
      if (g > 0)
        for (; c--; )
          typeof b[c] === 'number' &&
            ((m = a.radii[c]),
            (d = Math.min((b[c] - i) * k - m, d)),
            (e = Math.max((b[c] - i) * k + m, e)));
    });
    p.length &&
      g > 0 &&
      q(this.options.min, this.userMin) === D &&
      q(this.options.max, this.userMax) === D &&
      ((e -= b),
      (k *= (b + d - e) / b),
      (this.min += d / k),
      (this.max += e / k));
          ...
          d === !0 && (d = {}),
            b
              ? ((c = {
                ...
                e.attr(c),
                j && j.attr(c))
              : ((c = { translateX: g, translateY: k, scaleX: 1, scaleY: 1 }),
                e.animate(c, d),
                j && j.animate(c, d),
                (this.animate = null));
      } else a.call(this, b);

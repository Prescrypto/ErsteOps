...
(function() {
  ...
  function Nb() {
    ...
    lb = function(a, c, d, h, i, j) {
      var k;
      b
        ? ((k = ea.UTC.apply(0, arguments)), (k += ab(k)))
        : (k = new ea(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0)).getTime());
      return k;
    };
    yb = c + 'Minutes';
    zb = c + 'Hours';
  ...
  z.numberFormat = function(a, b, c, d) {
    var e = F.lang,
      ...
      f =
        b === -1
          ? B((a.toString().split('.')[1] || '').length, 20)
          : isNaN((b = R(b))) ? 2 : b,
  ...
  F = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        'http://code.highcharts.com/stock/2.1.3/modules/canvas-tools.js',
      VMLRadialGradientURL:
        'http://code.highcharts.com/stock/2.1.3/gfx/vml-radial-gradient.png',
    },
    chart: {
      borderColor: '#4572A7',
      borderRadius: 0,
        ...
        a && a.stops
          ...
          : (c = bc.exec(a))
            ...
            : (c = cc.exec(a))
              ...
              : (c = dc.exec(a)) && (b = [C(c[1]), C(c[2]), C(c[3]), 1]);
      })(a);
      return {
        get: function(c) {
          var f;
  ...
  $.prototype = {
      ...
      if (f) {
        ...
        h[q]
          ...
          : ((g.id = a = 'highcharts-' + Hb++),
            ...
            n(j, function(a) {
              a[1].indexOf('rgba') === 0
                ? ((e = wa(a[1])), (k = e.get('rgb')), (l = e.get('a')))
                : ((k = a[1]), (l = 1));
              a = d
                .createElement('stop')
    ...
    clip: function(a) {
      return this.attr(
        'clip-path',
        a ? 'url(' + this.renderer.url + '#' + a.id + ')' : Z
      );
    },
    crisp: function(a) {
      var b,
    ...
    css: function(a) {
      ...
      if (e) {
        e = this.textWidth =
          (a && a.width && d.nodeName.toLowerCase() === 'text' && C(a.width)) ||
          this.textWidth;
        b && (a = x(b, c));
        this.styles = a;
      ...
      $a && a === 'click'
        ? ((d.ontouchstart = function(a) {
          ...
          (d.onclick = function(a) {
            (Ga.indexOf('Android') === -1 ||
              ea.now() - (c.touchEventFired || 0) > 1100) &&
              b.call(d, a);
          }))
        : (d['on' + a] = b);
      return this;
    ...
    align: function(a, b, c) {
      ...
      f = e.alignedObjects;
      if (a) {
        if (((this.alignOptions = a), (this.alignByTranslate = b), !c || Ja(c)))
    ...
    getBBox: function(a) {
      ...
      d !== r &&
        ...
        (l =
          d === '' || Xb.test(d) ? 'num:' + d.toString().length + l : d + l));
      l && !a && (b = c.cache[l]);
      if (!b) {
    ...
    show: function(a) {
      a && this.element.namespaceURI === Ha
  ...
  $.prototype.translateXSetter = $.prototype.translateYSetter = $.prototype.rotationSetter = $.prototype.verticalAlignSetter = $.prototype.scaleXSetter = $.prototype.scaleYSetter = function(
    a,
    b
  ) {
    this[b] = a;
  ...
  $.prototype['stroke-widthSetter'] = $.prototype.strokeSetter = function(
    a,
    b,
    c
  ) {
  ...
  na.prototype = {
    ...
    init: function(a, b, c, d, e) {
      ...
      this.alignedObjects = [];
      this.url =
        (Va || Gb) && E.getElementsByTagName('base').length
          ? f.href
              .replace(/#.*?$/, '')
              .replace(/([\('\)])/g, '\\$1')
              .replace(/ /g, '%20')
      ...
      this.createElement('desc')
        .add()
        .element.appendChild(E.createTextNode('Created with Highstock 2.1.3'));
    ...
    buildText: function(a) {
      for (
        ...
        b.removeChild(g[t]);
      !f && !o && !q && e.indexOf(' ') === -1
        ? b.appendChild(E.createTextNode(u(e)))
        : ((h = /<.*style="([^"]+)".*>/),
          (i = /<.*href="(http[^"]+)".*>/),
          J && J.appendChild(b),
          (e = f
          ...
          n(e, function(e, f) {
            ...
            n(g, function(e) {
              if (e !== '' || g.length === 1) {
                ...
                i.test(e) &&
                  !d &&
                  (W(t, 'onclick', 'location.href="' + e.match(i)[1] + '"'),
                  M(t, { cursor: 'pointer' }));
                e = u(e.replace(/<(.|\n)*?>/g, '') || ' ');
                if (e !== ' ') {
                  ...
                  !m &&
                    f &&
                    (!da && d && M(t, { display: 'block' }), W(t, 'dy', N(t)));
                  if (l) {
                    for (
                      ...
                      (a.rotation = 0),
                        ...
                        !da &&
                          c.forExport &&
                          (r = c.measureSpanWidth(t.firstChild.data, a.styles)),
                        (p = r > l),
                        A === void 0 && (A = p),
                        q && A
                          ? ((B /= 2),
                          ...
                          : !p || o.length === 1
                            ? ((o = s),
                              ...
                              o.length &&
                                ...
                                b.appendChild(t)),
                              r > l && (l = r))
                            : (t.removeChild(t.firstChild), s.unshift(o.pop())),
                        o.length &&
                          t.appendChild(
                            E.createTextNode(o.join(' ').replace(/- /g, '-'))
                          );
    ...
    button: function(a, b, c, d, e, f, g, h, i) {
      ...
      j.setState = function(a) {
        (j.state = k = a)
          ? a === 2 ? j.attr(g).css(t) : a === 3 && j.attr(h).css(J)
          : j.attr(e).css(o);
      };
      return j
        .on('click', function() {
    ...
    rect: function(a, b, c, d, e, f) {
      var e = ia(a) ? a.r : e,
        ...
        a = ia(a)
          ? a
          : a === r ? {} : { x: a, y: b, width: v(c, 0), height: v(d, 0) };
    ...
    symbol: function(a, b, c, d, e, f) {
      ...
      if (h)
        (g = this.path(h)),
          x(g, { symbolName: a, x: b, y: c, width: d, height: e }),
          f && x(g, f);
      else if (i.test(a))
        (k = function(a, b) {
          a.element &&
            ...
            a.alignByTranslate ||
              a.translate(w((d - b[0]) / 2), w((e - b[1]) / 2)));
        }),
          (j = a.match(i)[1]),
    ...
    fontMetrics: function(a, b) {
      ...
      if (b && T.getComputedStyle)
        (b = b.element || b), (a = T.getComputedStyle(b, '').fontSize);
    ...
    label: function(a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        a = q.element.style;
        J =
          (oa === void 0 || v === void 0 || o.styles.textAlign) &&
          s(q.textStr) &&
          q.getBBox();
        ...
        if (E) {
          if (!t)
            (a = w(-p * u)),
              (b = h ? -D : 0),
              (o.box = t = d
                ? m.symbol(d, a, b, o.width, o.height, L)
                : m.rect(a, b, o.width, o.height, 0, L[Yb])),
              t.attr('fill', Z).add(o);
      ...
      function k() {
        var a = o.styles,
          ...
          c;
        c = h ? 0 : D;
        if (s(oa) && J && (a === 'center' || a === 'right'))
          b += { center: 0.5, right: 1 }[a] * (oa - J.width);
      ...
      if (this.added) {
        ...
        if (b.tagName === 'SPAN') {
          ...
          if (o !== this.cTT) {
            ...
            if (i > m && /[ \-]/.test(b.textContent || b.innerText))
              M(b, {
                width: m + 'px',
                display: 'block',
    ...
    setSpanRotation: function(a, b, c) {
      var d = {},
        e = Da
          ...
          : Gb
            ? '-webkit-transform'
            : Va ? 'MozTransform' : Rb ? '-o-transform' : '';
      d[e] = d.transform = 'rotate(' + a + 'deg)';
      d[e + (Va ? 'Origin' : '-origin')] = d.transformOrigin =
        b * 100 + '% ' + c + 'px';
      M(this.element, d);
    },
    ...
    (G = {
      ...
      dashstyleSetter: function(a, b, c) {
        (c.getElementsByTagName('stroke')[0] ||
          aa(this.renderer.prepVML(['<stroke/>']), null, null, c))[b] =
          a || 'solid';
        this[b] = a;
      },
      dSetter: function(a, b, c) {
      ...
      (z.VMLElement = G = ja($, G)),
      (G.prototype.ySetter = G.prototype.widthSetter = G.prototype.heightSetter =
        G.prototype.xSetter),
      (G = {
        Element: G,
        ...
        init: function(a, b, c, d) {
          var e;
          this.alignedObjects = [];
          d = this.createElement(Ua).css(
            x(this.getStyle(d), { position: 'relative' })
          );
          e = d.element;
          ...
          if (!E.namespaces.hcv) {
            ...
            try {
              E.createStyleSheet().cssText =
                'hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } ';
            } catch (f) {
              E.styleSheets[0].cssText +=
                'hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } ';
            }
          }
        },
        ...
        color: function(a, b, c, d) {
          ...
          if (i) {
            ...
            n(a, function(a, b) {
              g.test(a[1])
                ? ((f = wa(a[1])), (k = f.get('rgb')), (l = f.get('a')))
                : ((k = a[1]), (l = 1));
              oa.push(a[0] * 100 + '% ' + k);
              b ? ((t = l), (J = k)) : ((q = l), (p = k));
            });
              ...
              if (i === 'gradient')
                ...
                var j = m.r,
                  ...
                  j = function() {
                    y &&
                      ((B = d.getBBox()),
                      (v += (y[0] - B.x) / B.width - 0.5),
                      (x += (y[1] - B.y) / B.height - 0.5),
                      (s *= y[2] / B.width),
                      (w *= y[2] / B.height));
                    u =
                      'src="' +
                      F.global.VMLRadialGradientURL +
                      '" size="' +
                      s +
                      ',' +
                      w +
        ...
        createElement: function(a) {
          return a === 'rect'
            ? this.symbol(a)
            : na.prototype.createElement.call(this, a);
        },
        ...
        A === 'inside' && (n = -n),
          ...
          o
            ...
            : (this.mark = f
                ...
                .add(d.axisGroup));
      if (i && !isNaN(x))
        (i.xy = v = this.getLabelPosition(x, v, i, g, k, w, a, oa)),
          ...
          (this.isLast && !this.isFirst && !p(e.showLastLabel, 1))
            ...
            : g &&
              ...
              !b &&
              c !== 0 &&
              this.handleOverflow(v),
          oa && a % oa && (s = !1),
          s && !isNaN(v.y)
            ? ((v.opacity = c),
              i[this.isNew ? 'attr' : 'animate'](v),
              (this.isNew = !1))
            : i.attr('y', -9999);
    },
    destroy: function() {
    ...
    render: function() {
      ...
      if (e && s(e.text) && o && o.length && b.width > 0 && b.height > 0) {
        ...
        if (!f) {
          ...
          if (s(p)) u.zIndex = p;
          a.label = f = A.text(e.text, 0, 0, e.useHTML)
            .attr(u)
            .css(e.style)
            .add();
        }
  ...
  O.prototype = {
    ...
    init: function(a, b) {
      ...
      this.crosshair = p(
        d.crosshair,
        pa(a.options.tooltip.crosshairs)[c ? 0 : 1],
        !1
      );
      var f,
    ...
    defaultLabelFormatter: function() {
      ...
      g === r &&
        (g = R(b) >= 1e4 ? z.numberFormat(b, 0) : z.numberFormat(b, -1, r, ''));
      return g;
    },
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              (a.dataMin = B(p(a.dataMin, d[0]), Sa(d))),
      ...
      if (b.isXAxis || i || d)
        h
          ...
          : n(b.series, function(a) {
              ...
              d = v(d, h);
              b.single ||
                ((f = v(f, Ja(j) ? 0 : h / 2)), (g = v(g, j === 'on' ? 0 : h)));
    ...
    setTickInterval: function(a) {
      ...
      if (e)
        !a && B(b.min, p(b.dataMin, b.min)) <= 0 && qa(10, 1),
          (b.min = la(La(b.min))),
          (b.max = la(La(b.max)));
      if (b.range && s(b.max))
        ...
        b.min === b.max || b.min === void 0 || b.max === void 0
          ...
          : h && !k && l === b.linkedParent.options.tickPixelInterval
            ...
            : p(
                k,
                this.tickAmount
                  ? (b.max - b.min) / v(this.tickAmount - 1, 1)
                  : void 0,
                m ? 1 : (b.max - b.min) * l / v(b.len, l)
              );
      g &&
        !a &&
        n(b.series, function(a) {
    ...
    zoom: function(a, b) {
      ...
      this.allowZoomOutside ||
        (s(c) && a <= B(c, p(e.min, c)) && (a = r),
        s(d) && b >= v(d, p(e.max, d)) && (b = r));
    ...
    unsquish: function() {
      ...
      c
        ? (l = s(h)
            ? [h]
            : f < 80 && !b.staggerLines && !b.step && b.autoRotation) &&
          n(l, function(a) {
            var b;
            a &&
              a >= -90 &&
        ...
        if (
          ...
          n(e, function(b) {
            if (
              ...
              J = v(f[b].getLabelSize(), J);
          }),
          a.staggerLines)
        )
          (J *= a.staggerLines), (a.labelOffset = J);
    ...
    render: function() {
      ...
      if (t || f) {
        ...
        if (
          ...
          i[-1] || (i[-1] = new Za(a, -1, null, !0)), i[-1].render(-1);
        m &&
          n(g, function(b, c) {
            if (c % 2 === 0 && b < a.max)
              k[b] || (k[b] = new z.PlotLineOrBand(a)),
                (u = b + o),
    ...
    if (s(b)) {
      ...
      for (
        var d = i.getTime(),
          l = i[cb](),
          m = i[bb](),
          o = (H.day + (g ? ab(i) : i.getTimezoneOffset() * 6e4)) % H.day;
        d < c;
  ...
  O.prototype.getLogTickPositions = function(a, b, c, d) {
    ...
    if (a >= 0.5) (a = w(a)), (g = this.getLinearTickPositions(a, b, c));
      ...
      (a = wb(a, null, vb(a))),
      (g = za(this.getLinearTickPositions(a, b, c), La)),
      !d)
    )
  ...
  Kb.prototype = {
    ...
    getAnchor: function(a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === r && (b = d.pointer.normalize(b)),
    ...
    refresh: function(a, b) {
      ...
      i === !1
        ? this.hide()
        : (this.isHidden && (gb(d), d.attr('opacity', 1).show()),
          d.attr({ text: i }),
    ...
    getXDateFormat: function(a, b, c) {
      ...
      if (e) {
        ...
        for (f in H) {
          if (
            e === H.week &&
            +ka('%w', a.x) === c.options.startOfWeek &&
  ...
  Xa.prototype = {
    init: function(a, b) {
      ...
      this.pinchDown = [];
      this.lastValidTouch = {};
      if (z.Tooltip && b.tooltip.enabled)
    ...
    normalize: function(a, b) {
      ...
      d = a.touches
        ? a.touches.length ? a.touches.item(0) : a.changedTouches[0]
        : a;
    ...
    runPointActions: function(a) {
      ...
      if (!f && !i)
        for (g = 0; g < d.length; g++)
          if (d[g].directTouch || !d[g].options.stickyTracking) d = [];
      (!i || !i.noSharedTooltip) && (f || !i)
        ? (n(d, function(b) {
          ...
          n(m, function(a) {
            if (
              ...
              s(a.plotY) &&
              (a.dist.distX < j ||
                ((a.dist.distX === j || a.series.kdDimensions > 1) &&
                  a.dist.distR < k))
            )
              (j = a.dist.distX), (k = a.dist.distR), (o = a);
          }))
        : (o = i ? i.searchPoint(a) : r);
      if (o && o !== h)
        if (f && !o.series.noSharedTooltip) {
          g = m.length;
          for (d = o.clientX; g--; )
            (i = m[g].clientX),
              (m[g].x !== o.x ||
                i !== d ||
                !s(m[g].y) ||
                m[g].series.noSharedTooltip) &&
                m.splice(g, 1);
          e && e.refresh(m, a);
          n(m, function(b) {
            b.onMouseOver(a);
          });
        } else e && e.refresh(o, a), o.onMouseOver(a);
      else
        (g = i && i.tooltipOptions.followPointer),
          e &&
            g &&
            !e.isHidden &&
            ((g = e.getAnchor([{}], a)),
            e.updatePosition({ plotX: g[0], plotY: g[1] }));
    ...
    drag: function(a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          f &&
          ((d -= m),
          this.selectionMarker.attr({ width: R(d), x: (d > 0 ? 0 : d) + m }));
        this.selectionMarker &&
          g &&
          ((d = e - o),
          this.selectionMarker.attr({ height: R(d), y: (d > 0 ? 0 : d) + o }));
    ...
    destroy: function() {
      ...
      fb ||
        (U(E, 'mouseup', this.onDocumentMouseUp),
  ...
  x(z.Pointer.prototype, {
    ...
    pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
      ...
      b < u.min
        ? ((b = u.min), (x = !0))
        : b + q > u.max && ((b = u.max - q), (x = !0));
      x
        ? ((s -= 0.8 * (s - g[j][0])), A || (w -= 0.8 * (w - g[j][1])), c())
        : (g[j] = [s, w]);
      n || ((f[j] = t - o), (f[m] = q));
      f = n ? 1 / p : p;
      e[m] = q;
  ...
  if (T.PointerEvent || T.MSPointerEvent) {
    ...
    x(Xa.prototype, {
      ...
      batchMSEvents: function(a) {
        a(
          ...
          Lb ? 'pointerdown' : 'MSPointerDown',
          this.onContainerPointerDown
        );
        a(
          this.chart.container,
          Lb ? 'pointermove' : 'MSPointerMove',
    ...
    S(Xa.prototype, 'init', function(a, b, c) {
      ...
      (this.hasZoom || this.followTouchMove) &&
        M(b.container, { '-ms-touch-action': Z, 'touch-action': Z });
    });
  ...
  rb.prototype = {
    ...
    renderItem: function(a) {
      ...
      if (!n) {
        ...
        a.legendItem = n = c
          .text(
            d.labelFormat ? Ma(d.labelFormat, a) : d.labelFormatter.call(a),
            l ? f + g : -g,
            this.baseline || 0,
            A
          )
          ...
          .add(a.legendGroup);
        if (!this.baseline)
          (this.baseline = c.fontMetrics(h.fontSize, n).f + 3 + q),
      ...
      if (e && this.itemX - t + f > (m || b.chartWidth - 2 * j - t - d.x))
        (this.itemX = t), (this.itemY += q + this.lastLineHeight + o);
    ...
    getAllItems: function() {
      ...
      n(this.chart.series, function(b) {
        var c = b.options;
        if (p(c.showInLegend, !s(c.linkedTo) ? r : !1, !0))
          a = a.concat(
  ...
  (/Trident\/7\.0/.test(Ga) || Va) &&
    S(rb.prototype, 'positionItem', function(a, b) {
      var c = this,
        d = function() {
  ...
  Pa.prototype = {
    ...
    layOutTitles: function(a) {
      ...
      if (
        ...
        (c
          ...
          .align(
            x({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f),
            !1,
            'spacingBox'
          ),
    ...
    getContainer: function() {
      ...
      this.renderer = b.forExport
        ? new na(a, c, d, b.style, !0)
        : new Wa(a, c, d, b.style);
      ...
      if (k)
        f
          ...
          : (this.plotBackground = b
              ...
              .shadow(a.plotShadow));
      if (l)
        h ? h.animate(u) : (this.plotBGImage = b.image(l, q, t, p, n).add());
      r
        ? r.animate({ width: s.width, height: s.height })
        : (this.clipRect = b.clipRect(s));
      if (m)
        g
          ? g.animate(
              g.crisp({ x: q, y: t, width: p, height: n, strokeWidth: -m })
            )
          : (this.plotBorder = b
              .rect(q, t, p, n, 0, -m)
              .attr({
    ...
    linkSeries: function() {
      ...
      n(b, function(b) {
        ...
        if (Ja(d) && (d = d === ':previous' ? a.series[b.index - 1] : a.get(d)))
    ...
    isReadyToRender: function() {
      var a = this;
      return (!da && T == T.top && E.readyState !== 'complete') ||
        (ma && !T.canvg)
        ? (ma
            ? Tb.push(function() {
                a.firstRender();
  ...
  P.prototype = {
      ...
      if (
        ...
        if (o && h > o) {
          ...
          if (sa(k)) {
            ...
            if (J)
              for (c = 0; c < h; c++)
                (i = a[c]), (q[c] = i[0]), (t[c] = i.slice(1, J + 1));
            else
              for (c = 0; c < h; c++) (i = a[c]), (q[c] = i[0]), (t[c] = i[1]);
          else qa(12);
        } else
          for (c = 0; c < h; c++)
            if (
    ...
    processData: function(a) {
      ...
      if (k && this.sorted && (!i || d > i || this.forceCrop))
        ...
        else if (b[0] < l || b[d - 1] > m)
          (e = this.cropData(this.xData, this.yData, l, m)),
            (b = e.xData),
            (c = e.yData),
            (e = e.start),
            (f = !0);
    ...
    generatePoints: function() {
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ? (l[m] = new f().init(this, [d[m]].concat(pa(e[m]))))
            : (b[i]
                ? (k = b[i])
                : a[i] !== r && (b[i] = k = new f().init(this, a[i], d[m])),
              (l[m] = k)),
          (l[m].index = i);
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++)
    ...
    translate: function() {
      ...
      for (
        ...
        if (e.isLog && N !== null && N <= 0) (t.y = N = null), qa(10);
        t.plotX = l = c.translate(n, 0, 0, 0, 1, i, this.type === 'flags');
        if (b && this.visible && u && u[n])
          (u = u[n]),
        ...
        t.plotY = m =
          typeof N === 'number' && N !== Infinity
            ? B(v(-1e5, e.translate(N, 0, 1, 0, 1)), 1e5)
            : r;
        ...
        i.hide(),
          ...
          n(d, function(d, i) {
            ...
            b.inverted &&
              c.isVML &&
              (h = l.isXAxis
                ? { x: 0, y: m ? e : f, height: h.width, width: b.chartWidth }
                : {
      ...
      for (p = 0; p < d; p++) {
        ...
        if (!l[q][n])
          m[q] && m[q][n]
            ...
            : (l[q][n] = new Qb(k, k.options.stackLabels, o, n, g));
        q = l[q][n];
        q.points[t] = [q.cum || 0];
        e === 'percent'
          ? ((o = o ? h : i),
            j && l[o] && l[o][n]
              ? ((o = l[o][n]),
                (q.total = o.total = v(o.total, q.total) + R(u) || 0))
              : (q.total = la(q.total + (R(u) || 0))))
          : (q.total = la(q.total + (u || 0)));
        q.cum = (q.cum || 0) + (u || 0);
  ...
  Ca = ja(P, {
    ...
    getPointSpline: function(a, b, c) {
      ...
      if (f && g) {
        ...
        i > a && i > e
          ? ((i = v(a, e)), (k = 2 * e - i))
          : i < a && i < e && ((i = B(a, e)), (k = 2 * e - i));
        k > g && k > e
          ? ((k = v(g, e)), (i = 2 * e - k))
          : k < g && k < e && ((k = B(g, e)), (i = 2 * e - k));
        b.rightContX = j;
        b.rightContY = k;
      }
      c
  ...
  Ca = ja(P, {
      ...
      b.grouping === !1
        ...
        : n(a.chart.series, function(b) {
            ...
            if (
              ...
              c.stacking
                ? ((f = b.stackKey), g[f] === r && (g[f] = i++), (h = g[f]))
                : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h);
          });
      var c = B(
    ...
    translate: function() {
      ...
      n(a.points, function(c) {
        ...
        c.tooltipPos = b.inverted
          ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - n - r / 2]
          : [n + r / 2, h + e.pos - b.plotTop];
        r = w(n + r) + l;
        n = w(n) + l;
        r -= n;
        d = R(u) < 0.5;
      ...
      n(a.points, function(h) {
        ...
        if (i !== r && !isNaN(i) && h.y !== null)
          (f = h.shapeArgs),
            ...
            j
              ? (gb(j), j.attr(i)[b.pointCount < e ? 'animate' : 'attr'](y(f)))
    ...
    animate: function(a) {
      ...
      if (da)
        a
          ? ((e.scaleY = 0.001),
            (a = B(b.pos + b.len, v(b.pos, b.toPixels(c.threshold)))),
  ...
  Q = {
    ...
    pointClass: ja(Ba, {
      ...
      setVisible: function(a) {
        ...
        b.legendItem &&
          (d.hasRendered &&
            (c.updateTotals(), d.legend.clearItems(), e || d.legend.render()),
  ...
  P.prototype.alignDataLabel = function(a, b, c, d, e) {
    ...
    if (l)
      (d = x(
        ...
        x(c, { width: j.width, height: j.height }),
        c.rotation
  ...
  if (I.pie)
    (I.pie.prototype.drawDataLabels = function() {
          ...
          if (K) {
            ...
            for (L = b = 0; !b && H[L]; )
              (b =
                H[L] &&
                H[L].dataLabel &&
                (H[L].dataLabel.getBBox().height || 21)),
                L++;
            if (m > 0) {
              ...
              for (L = 0; L < K; L++) {
                ...
                var Q, O;
                for (O = 0; O < u; O++)
                  (Q = R(G[O] - A[1])), Q < c && ((c = Q), (F = O));
                if (F < L && G[L] !== null) F = L;
                else
                  for (
                    u < K - L + F && G[L] !== null && (F = u - K + L);
                    G[F] === null;
            ...
            for (L = 0; L < K; L++) {
              ...
              if (m > 0) {
                if (
                  ...
                  (F = u.i),
                  (z = u.y),
                  (c > z && G[F + 1] !== null) || (c < z && G[F - 1] !== null))
                )
                  z = B(v(0, c), d.plotHeight);
              } else z = c;
              y = e.justify
                ? o[0] + (E ? -1 : 1) * (q + m)
                : a.getX(z === t - q - m || z === t + q + m ? c : z, E);
              r._attr = { visibility: D, align: A[6] };
              r._pos = {
                x: y + e.x + ({ left: f, right: -f }[A[6]] || 0),
                y: z + e.y - 10,
              };
              r.connX = y;
              r.connY = z;
              if (this.options.size === null)
                (u = r.width),
                  y - u < f
                    ? (C[3] = v(w(u - y + f), C[3]))
                    : y + u > h - f && (C[1] = v(w(y + u - h + f), C[1])),
                  z - b / 2 < 0
                    ? (C[0] = v(w(-z + b / 2), C[0]))
                    : z + b / 2 > i && (C[2] = v(w(z + b / 2 - i), C[2]));
            }
          }
        }
      ...
      (I.pie.prototype.verifyDataLabelOverflow = function(a) {
        ...
        d[1] !== null
          ? (e = v(B(e, b[2] - v(a[0], a[2])), c))
          : ((e = v(B(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
        e < b[2]
          ? ((b[2] = e),
            this.translate(b),
            n(this.points, function(a) {
  ...
  x(Pa.prototype, {
    ...
    pan: function(a, b) {
      ...
      n(b === 'xy' ? [1, 0] : [1], function(b) {
        ...
        if (
          h.series.length &&
          (i || l > B(k.dataMin, k.min)) &&
          (!i || j < v(k.dataMax, k.max))
        )
      ...
      if (
        ...
        if (this.graphic)
          (g = g && this.graphic.symbolName && q.r),
            this.graphic.attr(
              y(q, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})
            ),
            k && k.hide();
        else {
          if (a && i)
  ...
  x(P.prototype, {
    ...
    setVisible: function(a, b) {
      var c = this,
        ...
        h = c.visible;
      f = (c.visible = a = c.userOptions.visible = a === r ? !h : a)
        ? 'show'
        : 'hide';
  ...
  S(O.prototype, 'getTimeTicks', function(a, b, c, d, e, f, g, h) {
    ...
    for (o = f.length; j < o; j++) {
      ...
      if (j === o - 1 || f[j + 1] - f[j] > g * 5 || q) {
        if (f[j] > n) {
          for (k = a.call(this, b, f[i], f[j], e); k.length && k[0] <= n; )
            k.shift();
    ...
    if (h && a.unitRange <= H.hour) {
      j = t.length - 1;
      for (i = 1; i < j; i++)
        ka('%d', t[i]) !== ka('%d', t[i - 1]) && ((l[t[i]] = 'day'), (m = !0));
      m && (l[t[0]] = 'day');
      a.higherRanks = l;
    }
    t.info = a;
    if (h && s(p)) {
      var h = (a = t.length),
        ...
        u;
      for (m = []; h--; )
        (i = this.translate(t[h])), u && (m[h] = u - i), (j[h] = u = i);
      m.sort();
      m = m[X(m.length / 2)];
      m < p * 0.6 && (m = null);
      h = t[a - 1] > d ? a - 1 : a;
      for (u = void 0; h--; )
        (i = j[h]),
          (d = u - i),
          u && d < p * 0.8 && (m === null || d < m * 0.8)
            ? (l[t[h]] && !l[t[h + 1]] ? ((d = h + 1), (u = i)) : (d = h),
              t.splice(d, 1))
            : (u = i);
    }
    return t;
    ...
    beforeSetTickPositions: function() {
      ...
      if (a.options.ordinal || a.options.breaks) {
        n(a.series, function(d, e) {
          if (
            d.visible !== !1 &&
            (d.takeOrdinalPosition !== !1 || a.options.breaks)
          )
            if (
              ((c = c.concat(d.processedXData)),
              (b = c.length),
              c.sort(function(a, b) {
                return a - b;
              }),
        ...
        if (b > 2) {
          ...
          if (
            ...
            (c[0] - g > e || f - c[c.length - 1] > e)
          )
            d = !0;
        }
        d
          ? ((a.ordinalPositions = c),
            (e = a.val2lin(v(g, c[0]), !0)),
            (h = v(a.val2lin(B(f, c[c.length - 1]), !0), 1)),
            (a.ordinalSlope = f = (f - g) / (h - e)),
            (a.ordinalOffset = g - e * f))
          : (a.ordinalPositions = a.ordinalSlope = a.ordinalOffset = r);
    ...
    lin2val: function(a, b) {
      ...
      if (c) {
        var d = this.ordinalSlope,
          ...
          h;
        if (b)
          a < 0 ? (a = c[0]) : a > f ? (a = c[f]) : ((f = X(a)), (h = a - f));
        else
          for (; f--; )
            if (((g = d * f + e), a >= g)) {
              d = d * (f + 1) + e;
      ...
      if (m.ordinalPositions) {
        if (R(f) > 1)
          k &&
            ...
            f < 0
              ? ((k = m), (q = c.ordinalPositions ? c : m))
              : ((k = c.ordinalPositions ? c : m), (q = m)),
            ...
            (f = c.toFixedRange(
              null,
              null,
              l.apply(k, [o.apply(k, [i, !0]) + f, !0]),
              l.apply(q, [o.apply(q, [j, !0]) + f, !0])
            )),
            f.min >= B(g.dataMin, i) &&
              f.max <= v(h, j) &&
              c.setExtremes(f.min, f.max, !0, !1, { trigger: 'pan' }),
            (this.mouseDownX = d),
      ...
      (b = this.segments),
        n(b, function(a, f) {
          for (var g = a.length - 1; g--; )
            a[g + 1].x - a[g].x > d.closestPointRange * c &&
              b.splice(f + 1, 0, a.splice(g + 1, a.length - g));
        });
  });
  (function(a) {
    function b() {
    ...
    e(g.prototype, {
      ...
      isInAnyBreak: function(a, b) {
        ...
        for (var d = this.options.breaks, e = d.length, f = !1, g = !1; e--; )
          this.isInBreak(d[e], a) &&
            ((f = !0), g || (g = c(d[e].showPoints, this.isXAxis ? !1 : !0)));
        return f && b ? f && !g : f;
      },
    });
    ...
    d(h.prototype, 'generatePoints', function(a) {
      ...
      if (c && d && (c.options.breaks || d.options.breaks))
        for (; g--; )
          if (((f = e[g]), c.isInAnyBreak(f.x, !0) || d.isInAnyBreak(f.y, !0)))
            e.splice(g, 1), this.data[g].destroyElements();
    });
    ...
    if (gc.apply(this, arguments) !== !1 && d) {
      ...
      if (j) {
        ...
        var k = a.getExtremes(),
          ...
          h = j * (k - d) / h * i,
          j = a.getTimeTicks(
            a.normalizeTimeTickInterval(h, c.units || Vb),
            d,
            k,
  ...
  Q.tooltipFooterHeaderFormatter = function(a, b) {
    var c = a.series,
      ...
      g,
      h = c.xAxis;
    h && h.options.type === 'datetime' && e && sa(a.key)
      ? ((c = c.currentDataGrouping),
        (e = e.dateTimeLabelFormats),
        c
          ? ((h = e[c.unitName]),
            c.count === 1 ? (f = h[0]) : ((f = h[1]), (g = h[2])))
          : !f && e && (f = this.getXDateFormat(a, d, h)),
        (f = ka(f, a.key)),
        g && (f += ka(g, a.key + c.totalRange - 1)),
        (d = d[(b ? 'footer' : 'header') + 'Format'].replace('{point.key}', f)))
      : (d = jc.call(this, a, b));
    return d;
  };
  ca.destroy = function() {
      ...
      n(a.points, function(k) {
        if (k.plotY !== r)
          (i = k.graphic),
            ...
            k.open !== null &&
              ((d = w(k.plotOpen) + f), h.push('M', j, d, 'L', j - g, d)),
            k.close !== null &&
              ((e = w(k.plotClose) + f), h.push('M', j, e, 'L', j + g, e)),
            i
              ? i.animate({ d: h })
              : (k.graphic = b.renderer
                  .path(h)
                  .attr(c)
                  .add(a.group));
      });
      ...
      for (j = c.length; j--; )
        if (
          ...
          (a = k.pointAttr[k.selected ? 'select' : ''] || b),
            l
              ? l.attr({ x: e, y: f, r: a.r, anchorX: o, anchorY: n })
              : (k.graphic = d
                  .label(
                    k.options.title || g.title || 'A',
                    e,
                    f,
                    i,
                    o,
  ...
  Eb.prototype = {
    drawHandle: function(a, b) {
      ...
      this.rendered ||
        ...
        e.push(h),
        (h = d
          .path(['M', -1.5, 4, 'L', -1.5, 12, 'M', 0.5, 4, 'L', 0.5, 12])
          .attr(g)
          .add(f[b])),
        e.push(h));
    ...
    render: function(a, b, c, d) {
      ...
      if (!isNaN(a)) {
        ...
        l.getExtremes &&
          (I = this.getUnionExtremes(!0)) &&
          (I.dataMin !== l.min || I.dataMax !== l.max) &&
          l.setExtremes(I.dataMin, I.dataMax, !0, !1);
        c = p(c, l.translate(a));
        d = p(d, l.translate(b));
        ...
        if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
          ...
          this.zoomedMin = v(
            this.fixedWidth ? this.zoomedMax - this.fixedWidth : B(c, d),
            0
          );
          ...
          if (!this.rendered) {
            if (y)
              (this.navigatorGroup = l = f
                .g('navigator')
                .attr({ zIndex: 3 })
                .add()),
                (this.leftShade = f
                  .rect()
                  .attr({ fill: r.maskFill })
                  .add(l)),
                r.maskInside
                  ? this.leftShade.css({ cursor: 'ew-resize ' })
                  : (this.rightShade = f
                      .rect()
                      .attr({ fill: r.maskFill })
                      .add(l)),
                (this.outline = f
                  .path()
                  .attr({ 'stroke-width': z, stroke: r.outlineColor })
                  .add(l));
            if (t)
              (this.scrollbarGroup = k = f.g('scrollbar').add()),
                (m = s.trackBorderWidth),
                (this.scrollbarTrack = o = f
                  .rect()
                  .attr({
                    x: 0,
                    y: (-m % 2) / 2,
                ...
                (this.scrollbar = m = f
                  ...
                  .add(k)),
                (this.scrollbarRifles = f
                  .path()
                  .attr({ stroke: s.rifleColor, 'stroke-width': 1 })
                  .add(k));
          }
          ...
          if (y) {
            this.leftShade[e](
              r.maskInside
                ? { x: g + b, y: x, width: c - b, height: A }
                : { x: g, y: x, width: b, height: A }
            );
            if (this.rightShade)
              this.rightShade[e]({
                x: g + c,
            ...
            this.outline[e]({
              d: [
                ...
                r.maskInside ? ['M', g + b + C, F, 'L', g + c - C, F] : []
              ),
            });
          ...
          if (t && k)
            this.drawScrollbarButton(0),
              ...
              k[e]({ translateX: i, translateY: w(F + A) }),
              o[e]({ width: j }),
              (g = n + b),
              (h = a - G),
              h < u && ((D = (u - h) / 2), (h = u), (g -= D)),
              (this.scrollbarPad = D),
              m[e]({ x: X(g) + (G % 2) / 2, width: h }),
              (u = n + b + a / 2 - 0.5),
    ...
    removeEvents: function() {
      ...
      this.navigatorEnabled &&
        this.baseSeries &&
        U(this.baseSeries, 'updatedData', this.updatedDataHandler);
    },
    init: function() {
      var a = this,
        b = a.chart,
      ...
      a.mouseDownHandler = function(d) {
        var d = b.pointer.normalize(d),
          ...
          x = eb ? 10 : 7;
        if (v > h && v < h + g + j)
          if ((h = !a.scrollbarEnabled || v < h + g) && Y.abs(s - e - m) < x)
            (a.grabbedLeft = !0),
              (a.otherHandlePos = f),
              (a.fixedExtreme = d.max),
              (b.fixedRange = null);
          else if (h && Y.abs(s - f - m) < x)
            (a.grabbedRight = !0),
              (a.otherHandlePos = e),
              (a.fixedExtreme = d.min),
              (b.fixedRange = null);
          else if (s > m + e - p && s < m + f + p)
            (a.grabbedCenter = s), (a.fixedWidth = r), (i = s - e);
          else if (s > k && s < k + l) {
            f = h
              ? s - m - r / 2
              : s < m
                ? e - r * 0.2
                : s > k + l - j ? e + r * 0.2 : s < m + e ? e - r : f;
            if (f < 0) f = 0;
            else if (f + r >= n)
              (f = n - r), (w = a.getUnionExtremes().dataMax);
            if (f !== e)
              (a.fixedWidth = r),
                (e = c.toFixedRange(f, f + r, null, w)),
                d.setExtremes(e.min, e.max, !0, !1, { trigger: 'navigator' });
          }
      };
      a.mouseMoveHandler = function(c) {
        ...
        if (c.pageX !== 0)
          (c = b.pointer.normalize(c)),
            ...
            a.grabbedLeft
              ? ((j = !0), a.render(0, 0, l - e, a.otherHandlePos))
              : a.grabbedRight
                ? ((j = !0), a.render(0, 0, a.otherHandlePos, l - e))
                : a.grabbedCenter &&
                  ((j = !0),
      ...
      S(b, 'getMargins', function(b) {
        ...
        a.top = h =
          ...
          this.chartHeight -
            ...
            a.scrollbarHeight -
            this.spacing[2] -
            (f.verticalAlign === 'bottom' && f.enabled && !f.floating
              ? e.legendHeight + p(f.margin, 10)
              : 0);
        if (c && d)
    ...
    updatedDataHandler: function() {
      ...
      if (!a.hasNavigatorData)
        (o.options.pointStart = b.xData[0]),
    ...
    destroy: function() {
      ...
      n([this.scrollbarButtons, this.handles, this.elementsToDestroy], function(
        a
      ) {
        Na(a);
      });
  ...
  Fb.prototype = {
    clickButton: function(a, b) {
      ...
      if (!(j === null || k === null || a === c.selected)) {
        if (q === 'month' || q === 'year')
          (l = { month: 'Month', year: 'FullYear' }[q]),
            o['set' + l](o['get' + l]() - t),
            (l = o.getTime()),
            (j = p(j, Number.MIN_VALUE)),
            isNaN(l) || l < j ? ((l = j), (m = B(l + i, k))) : (i = m - l);
        else if (i) (l = v(m - i, j)), (m = B(l + i, k));
        else if (q === 'ytd')
          if (h) {
            if (k === r)
              (j = Number.MAX_VALUE),
    ...
    updateButtonStates: function(a) {
      var b = this,
        ...
        j = b.buttons;
      a &&
        c.fixedRange !== w(d.max - d.min) &&
        (j[h] && j[h].setState(0), b.setSelected(null));
      n(b.buttonOptions, function(a, c) {
        ...
        e === w(d.max - d.min) && c !== h
          ? (b.setSelected(c), j[c].setState(2))
          : !i && (o || n || p || s)
            ? j[c].setState(3)
            : j[c].state === 3 && j[c].setState(0);
      });
    },
    ...
    drawInput: function(a) {
      ...
      this[a + 'Label'] = j = e
        .label(
          F.lang[h ? 'rangeSelectorFrom' : 'rangeSelectorTo'],
          this.inputGroup.offset
        )
        .attr({ padding: 2 })
        .css(y(d, f.labelStyle))
        .add(l);
      l.offset += j.width + 5;
      this[a + 'DateBox'] = k = e
        .label('', l.offset)
      ...
      i.onchange = function() {
        var a = i.value,
          ...
          j = e.dataMax;
        isNaN(d) &&
          ((d = a.split('-')), (d = ea.UTC(C(d[0]), C(d[1]) - 1, C(d[2]))));
        isNaN(d) ||
          (F.global.useUTC || (d += new ea().getTimezoneOffset() * 6e4),
          h
            ? d > b.maxInput.HCTime ? (d = r) : d < g && (d = g)
            : d < b.minInput.HCTime ? (d = r) : d > j && (d = j),
          d !== r &&
            c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, {
    ...
    render: function(a, b) {
      ...
      if (
        !c.rendered &&
        ((c.group = u = e.g('range-selector-buttons').add()),
        (c.zoomText = e
          .text(k.rangeSelectorZoom, p(m.x, t), p(m.y, d.plotTop - 35) + 15)
          .css(i.labelStyle)
          .add(u)),
        (r = p(m.x, t) + c.zoomText.getBBox().width + 5),
        (v = p(m.y, d.plotTop - 35)),
      ...
      o !== !1 &&
        ...
        s(o) ||
          ((d = u.getBBox()),
          g[g.translateX < d.x + d.width + 10 ? 'hide' : 'show']()),
  ...
  S(O.prototype, 'getPlotLinePath', function(a, b, c, d, e, f) {
    var g = this,
      h =
        this.isLinked && !this.series ? this.linkedParent.series : this.series,
      i = g.chart,
      j = i.renderer,
      k = g.left,
      l = g.top,
    ...
    isNaN(f) ||
      (g.horiz
        ...
        : n(u, function(a) {
            ...
            o = r = w(l + g.height - f);
            if (o < l || o > l + g.height)
              e ? (o = r = B(v(l, o), g.top + g.height)) : (b = !0);
            b || x.push('M', m, o, 'L', q, r);
          }));
  ...
  na.prototype.crispPolyLine = function(a, b) {
    ...
    for (c = 0; c < a.length; c += 6)
      a[c + 1] === a[c + 4] &&
        (a[c + 1] = a[c + 4] = w(a[c + 1]) - (b % 2) / 2),
        a[c + 2] === a[c + 5] &&
          (a[c + 2] = a[c + 5] = w(a[c + 2]) + (b % 2) / 2);
    return a;
  };
  if (Wa === z.VMLRenderer)
    hb.prototype.crispPolyLine = na.prototype.crispPolyLine;
  S(O.prototype, 'hideCrosshair', function(a, b) {
    a.call(this, b);
    s(this.crossLabelArray) &&
      (s(b)
        ? this.crossLabelArray[b] && this.crossLabelArray[b].hide()
        : n(this.crossLabelArray, function(a) {
            a.hide();
          }));
  });
    ...
    if (s(this.crosshair.label) && this.crosshair.label.enabled && s(c)) {
      ...
      if (!k)
        k = this.crossLabel = a.renderer
          ...
          .add();
      b
        ? ((l = c.plotX + i), (m = j + (h ? 0 : this.height)))
        : ((l = h ? this.width + i : 0), (m = c.plotY + j));
      if (m < j || m > j + this.height) this.hideCrosshair();
        ...
        if (b) {
          if (
            (this.options.tickPosition === 'inside' && !h) ||
            (this.options.tickPosition !== 'inside' && h)
          )
            m = k.y - c.height;
        } else m = k.y - c.height / 2;
        b
          ? ((d = i - c.x), (e = i + this.width - c.x))
          : ((d = this.labelAlign === 'left' ? i : 0),
  ...
  S(P.prototype, 'render', function(a) {
    if (this.chart.options._stock)
      ...
      this.animate.toString().indexOf('sharedClip') !== -1
        ? ((this.clipBox = y(this.chart.clipBox)),

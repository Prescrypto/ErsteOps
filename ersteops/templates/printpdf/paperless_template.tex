...
\begingroup%
  ...
  \begin{picture}(1,0.77245213)%
    ...
    %Folio
    \put(0.91336785,0.68838718){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{content.id}}\end{tabular}}}}%
    ...
    %Padecimiento
    \put(0.0159714,0.1825995){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{content.fix_current_condition}}\end{tabular}}}}%
    ...
    %Trauma
    \put(0.21257984,0.38532216){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {% for item in content.json_traumatics %}{{ item }},{% endfor %}\end{tabular}}}}%
    %Ojo Izquierdo
    \put(0.20991809,0.36213786){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont Ojo Izquierdo: {% for item in content.json_pupil_state_left%}{{ item }},{% endfor %}\end{tabular}}}}%
    %Ojo Derecho
    \put(0.20991809,0.35077424){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont Ojo Derecho:  {% for item in content.json_pupil_state_right%}{{ item }},{% endfor%}\end{tabular}}}}%
    \put(0.016641,0.38301062){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {% for item in content.json_consultation_reason %}{{ item }},{% endfor%}
    \end{tabular}}}}%
    %to_fix
    %Via Aerea
    \put(0.01535741,0.34684125){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}{% for item in content.json_airway %}\fontfamily{lmss}\selectfont\scriptsize {{ item.airway_type}} - {{ item.instruction }}\\{% endfor %}\end{tabular}}}}%
    ...
    %Electro
    \put(0.53673588,0.1536906){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_rhythm}}\end{tabular}}}}%    
    \put(0.63974772,0.15416371){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_frequency}}\end{tabular}}}}%
    \put(0.73901494,0.1542802){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_wave_p}}\end{tabular}}}}%
    \put(0.80638047,0.15431264){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_pr}}\end{tabular}}}}%
    \put(0.54883898,0.14280022){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_axis_qrs}}\end{tabular}}}}%
    \put(0.61275927,0.14232657){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_qrs}}\end{tabular}}}}%
    \put(0.66200174,0.1423264){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_st}}\end{tabular}}}}%
    \put(0.7368123,0.14137953){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_wave_t}}\end{tabular}}}}%
    \put(0.809729,0.1423264){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{content.electro_qt}}\end{tabular}}}}%    
    ...
    \put(0.47899072,0.62149126){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\tiny {{ item.time }}\end{tabular}}}}%
    \put(0.56346295,0.62149126){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.heart_rate }}\end{tabular}}}}%
    \put(0.62325414,0.62140804){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.respiratory_rate}}\end{tabular}}}}%
    \put(0.68836013,0.62140804){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.blood_pressure}}\end{tabular}}}}%
    \put(0.74651878,0.62149126){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.temperature}}\end{tabular}}}}%
    \put(0.81241818,0.62140804){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.oxygen_saturation}}\end{tabular}}}}%
    \put(0.87214411,0.62149126){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.glucometry}}\end{tabular}}}}%
    \put(0.93275252,0.62149126){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{ item.glassgow_total }}\end{tabular}}}}%
    {% endfor %}
    %Signos Vitales 2
...
\begingroup%
  ...
  \begin{picture}(1,0.77245213)%
    ...
    \put(0.02433222,0.72271027){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{content.fix_diagnostic_impresion}}\end{tabular}}}}%
    %Tratamiento
    \put(0.02377709,0.34714045){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont {{content.fix_treatment}} \end{tabular}}}}%
    %Derivacion

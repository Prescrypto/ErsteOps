...
\begingroup%
  ...
  \begin{picture}(1,0.77245213)%
    ...
    {% if content.attention_final_grade == 'G0' %}
      {% include "printpdf/latex_text.html" with position="0.37115545,0.574256" font_size="scriptsize" content_text="X" %}
    {% endif %}
    {% if content.attention_final_grade == 'G1' %}
      {% include "printpdf/latex_text.html" with position="0.42545332,0.57475133" font_size="scriptsize" content_text="X" %}
    {% endif %}
    {% if content.attention_final_grade == 'G2' %}
      {% include "printpdf/latex_text.html" with position="0.4811341,0.5742217" font_size="scriptsize" content_text="X" %}
    {% endif %}
    %Folio

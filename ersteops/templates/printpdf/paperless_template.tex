...
\begingroup%
  ...
  \begin{picture}(1,0.77245213)%
    ...
    \put(0.13358814,0.46425894){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{0.8}\smash{\begin{tabular}[t]{l}{% for item in content.json_consultation_reason %}\fontfamily{lmss}\selectfont\scriptsize {{ item }}\\{% endfor%}
    \end{tabular}}}}%
    %to_fix
    %Via Aerea
    ...
    %inmovilizacion
    \put(0.38134429,0.33628328){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{0.7}\smash{\begin{tabular}[t]{l}{% for item in content.json_inmovilization_type %}\fontfamily{lmss}\selectfont\scriptsize {{ item }}\\{% endfor%}
    \end{tabular}}}}%

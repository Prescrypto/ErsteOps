...
\begingroup%
  ...
  \begin{picture}(1,0.77245213)%
    ...
    {% for item in content.json_medications_farma %}
      {% if forloop.counter0 == 0 %}
        \put(0.26321649,0.32734768){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_name }}\end{tabular}}}}%
        \put(0.30511372,0.32734768){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_dose }}\end{tabular}}}}%
        \put(0.33483843,0.32720095){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_hrs }}\end{tabular}}}}%
      {% endif %}
      {% if forloop.counter0 == 1 %}
        \put(0.26342897,0.31837723){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_name }}\end{tabular}}}}%
        \put(0.3053262,0.31837723){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_dose }}\end{tabular}}}}%
        \put(0.33505092,0.31823051){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_hrs }}\end{tabular}}}}%
      {% endif %}
      {% if forloop.counter0 == 2 %}
        \put(0.26308947,0.3081286){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_name }}\end{tabular}}}}%
        \put(0.3049867,0.3081286){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_dose }}\end{tabular}}}}%
        \put(0.33471142,0.30798187){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_hrs }}\end{tabular}}}}%
      {% endif %}
    {% endfor %}

    {% for item in content.json_medications_amina %}
      {% if forloop.counter0 == 0 %}
        \put(0.26517407,0.28858281){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_name }}\end{tabular}}}}%
        \put(0.30543707,0.28852296){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_dose }}\end{tabular}}}}%
        \put(0.33395328,0.28858473){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_hrs }}\end{tabular}}}}%
      {% endif %}
      {% if forloop.counter0 == 1 %}
        \put(0.26491781,0.27987623){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_name }}\end{tabular}}}}%
        \put(0.30518081,0.27981639){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_dose }}\end{tabular}}}}%
        \put(0.33369702,0.27987816){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_hrs }}\end{tabular}}}}%
      {% endif %}
      {% if forloop.counter0 == 2 %}
        \put(0.26516689,0.27001966){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_name }}\end{tabular}}}}%
        \put(0.3054299,0.26995982){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_dose }}\end{tabular}}}}%
        \put(0.3339461,0.27002158){\color[rgb]{0.11764706,0.20784314,0.36862745}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\fontfamily{lmss}\selectfont\scriptsize {{ item.medication_hrs }}\end{tabular}}}}%
      {% endif %}
    {% endfor %}

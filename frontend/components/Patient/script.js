    ...
    return {
      ...
      options: [
              ...
              children: [
                {
                  id: '1-19110000',
                  label:
                    ' Tiene antecedentes de enfermedad cardíaca [Grado : 2]',
                },
                {
                  id: '1-19120000',
                  label:
                    ' No tiene antecedentes de enfermedad cardíaca [Grado:3]',
                },
              ],
            },
            {
          ...
          children: [
            {
              id: '1-21100000',
              label:
                ' Comenzó hace menos de 6 horas o se desconoce [Grado : 2]',
            },
            {
              id: '1-21200000',
                              ...
                              children: [
                                {
                                  id: '1-28222421',
                                  label:
                                    ' Primer o segundo trimestre [Grado : 2]',
                                },
                                {
                                  id: '1-28222422',
                  ...
                  children: [
                    {
                      id: '1-44221000',
                      label:
                        ' En cara-torso-abdomen o todo miembro [Grado : 1]',
                    },
                    {
                      id: '1-44222000',
                      label:
                        ' No en cara-torso-abdomen o todo miembro [Grado : 3P]',
                    },
                  ],
                },
              ],
              ...
              children: [
                {
                  id: '1-55210000',
                  label:
                    ' Cuando se golpeó tuvo pérdida de conocimiento [Grado : 1]',
                },
                {
                  id: '1-55220000',
          ...
          children: [
            {
              id: '1-113100000',
              label:
                ' Tiene hemorragia genital o pérdida de líquido [Grado: 2]',
            },
            {
              id: '1-113200000',
        ...
        },
        {
          id: '2-101000000',
          label:
            '(Pediatrico) PARESIA (DIFICULTAD MOV.DE 1 O MAS MIEMBROS O BOCA',
          children: [
            {
              id: '2-101100000',
              label: ' Menor de tres horas de evolución [Grado: 2]',
                      ...
                      children: [
                        {
                          ...
                          children: [
                            ...
                            },
                            {
                              id: '2-18122220',
                              label:
                                ' No tiene dificultad para dormir o alimentarse',
                            },
                          ],
                        },
                        {
